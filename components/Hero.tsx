      ...
      <section className="pt-20 md:pt-24 pb-12 px-5 sm:px-8 md:px-12 relative overflow-hidden min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_auto] gap-12 xl:gap-24 items-center w-full">
          ...
          <div>
            ...
            <p className="text-[11px] text-soft/50 mt-4 max-w-[460px] leading-relaxed">
              By joining, you agree to our{' '}
              <a href="/privacy" className="underline underline-offset-2 hover:text-soft/80 transition-colors">Privacy Policy</a>
              {' '}and{' '}
              <a href="/terms" className="underline underline-offset-2 hover:text-soft/80 transition-colors">Terms of Service</a>.
              {' '}SMS opt-in is collected separately within the app and is not required. Msg &amp; data rates may apply.
            </p>
          </div>
