...
const Footer: React.FC = () => {
  return (
    <footer className="border-t border-rim px-5 sm:px-8 md:px-12 py-6 sm:py-7 relative z-10">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-5">
        ...
        <div className="flex items-center gap-6 sm:gap-8 text-[11px] text-soft font-medium tracking-[0.12em] uppercase">
