      ...
      <main className="flex-1 px-8 md:px-12 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="border-b border-rim pb-10 mb-14">
            <p className="text-[11px] font-medium tracking-[0.28em] uppercase text-soft mb-5">
            ...
            <p className="text-[14px] text-soft leading-[1.75] max-w-2xl">
          ...
          <div className="mb-16 bg-surface border border-rim p-6 md:p-8">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-[13px] text-soft leading-relaxed">
          ...
          <div>
            {steps.map((step) => (
              <div key={step.number} className="border-t border-rim py-14">
                <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">

                  <div>
                    <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-soft mb-3">
                      Step {step.number}
                    </p>
                    <h2
                    ...
                    <p className="text-[12px] font-medium text-accent/80 tracking-wide uppercase mb-6">
                      {step.where}
                    </p>
                    <p className="text-[13px] text-soft leading-[1.7] mb-6">
                      {step.what}
                    </p>
                    ...
                    <div className="border border-accent/20 bg-accent/5 p-5">
                      ...
                      <p className="text-[13px] text-cream/80 leading-[1.75] italic">
                        "{step.consent}"
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    <div
                      className="w-full border border-rim bg-surface flex flex-col items-center justify-center overflow-hidden"
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            parent.innerHTML = `<div style="padding:2rem;text-align:center;opacity:0.4">
          ...
          <div className="border-t border-rim pt-14">
            <h2 className="font-display font-semibold text-cream text-[1.4rem] mb-6">
              Opt-Out Methods
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={item.method} className="border border-rim p-6">
                  <p className="text-[11px] font-bold tracking-[0.15em] uppercase text-accent mb-2">{item.method}</p>
          ...
          <div className="border-t border-rim pt-10 mt-10">
